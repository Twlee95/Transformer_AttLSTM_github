...
from transformer_Stock_Dataset import StockDataset
from transformer_Stock_Dataset import Data_Spliter_CrossVal
from transformer_Stock_Dataset import Train_Data_Spliter_CrossVal
import os
import csv
...
# ====== Experiment Variable ====== #
data_list = ['^KS11']
args.save_file_path = "C:\\Users\\USER\\PycharmProjects\\transformer_attentionlstm_Github\\transformer_results"
